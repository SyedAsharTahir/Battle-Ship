...
.data
    ...
    menu_option1 BYTE "1. Start New Game",0Dh,0Ah,0
    ...
    invalid_choice_msg BYTE "Invalid choice! Please enter 1-4.",0Dh,0Ah,0
    ...
    how_to_play9 BYTE "- Last player with ships remaining wins!",0Dh,0Ah,0Dh,0Ah,0
    ...
    input_prompt BYTE "Enter target coordinates (e.g., A5): ",0
    hit_msg BYTE "*** HIT! ***",0Dh,0Ah,0
    miss_msg BYTE "MISS!",0Dh,0Ah,0
    win_msg BYTE "*** PLAYER ",0
    win_suffix BYTE " WINS! ***",0Dh,0Ah,0
    invalid_msg BYTE "Invalid input! Try again.",0Dh,0Ah,0
